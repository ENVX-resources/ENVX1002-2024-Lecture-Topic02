...
![Source: https://www.omniconvert.com/what-is/sample-size/](images/L2_sample-size-definition.png)
...
![](images/L2_Rlogo.jpg) - `sum(c(48, 56, 78, 86, 90, 271))`
...
![](images/L2_Excellogo.jpg) - `=SUM(A1:A6)`
...
![](images/L2_Rlogo.jpg) - `mean(c(48, 56, 78, 86, 90, 271))`
...
![](images/L2_Excellogo.jpg) - `=AVERAGE(A1:A6)`
...
![](images/L2_Rlogo.jpg) - `median(c(48, 56, 78, 86, 90, 271))`
...
![](images/L2_Excellogo.jpg) - `=MEDIAN(A1:A6)`
...
![](images/L2_Excellogo.jpg) - `=MODE.SNGL(A1:A7)`
...
![](images/L2_Rlogo.jpg) - `max(c(48, 56, 78, 86, 90, 271)) - min(c(48, 56, 78, 86, 90, 271))`
...
![](images/L2_Excellogo.jpg) - `=MAX(A1:A6) - MAX(A1:A6)`
...
![](images/L2_Rlogo.jpg) - `quantile(c(48, 56, 78, 86, 90, 271))`
...
![](images/L2_Excellogo.jpg) - `=QUARTILE.INC(A1:A6, 1)` - first quartile
...
![](images/L2_Rlogo.jpg) - `IQR(c(48, 56, 78, 86, 90, 271))`
...
![](images/L2_Excellogo.jpg) - `=QUARTILE.INC(A1:A6, 3)-QUARTILE.INC(A1:A6, 1)` - third quartile - first quartile
...
Sample variance: $\s^2 = \frac{\sum_{i=1}^{n}(y_i - \overline{y})^2}{n}$

![](images/L2_Rlogo.jpg) - `var(c(48, 56, 78, 86, 90, 271))`
...
![](images/L2_Excellogo.jpg) - `=VAR.S(A1:A6)`
...
Population standard deviation: $\sigma^2 = \sqrt{\frac{\sum_{i=1}^{N}(y_i - \mu)^2}{N}}$

Sample variance: $s^2 = \sqrt{\frac{\sum_{i=1}^{n}(y_i - \overline{y})^2}{n-1}}$
...
![](images/L2_Rlogo.jpg) - `sd(c(48, 56, 78, 86, 90, 271))`
...
![](images/L2_Excellogo.jpg) - `=STDEV.S(A1:A6)`
...
![](images/L2_Excellogo.jpg) - `=(STDEV.S(A1:A6)/AVERAGE(A1:A6))*100`
...
# Create the bar plot
ggplot(disease_df, aes(x = Disease, y = Frequency)) +
...
- Often if we have a small data set (1-5 data points), we can use a stripchart to visualise our data. We will demonstrate using our soil carbon dataset.
...
ggplot(soil_c_df, aes(x = "", y = Value)) +
  geom_jitter(width = 0) +
